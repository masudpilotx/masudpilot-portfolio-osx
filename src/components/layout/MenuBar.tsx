...
export const MenuBar: React.FC = () => {
  ...
  const { system, setControlCenterOpen } = useStore();
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-[30px] bg-black/20 backdrop-blur-xl flex items-center justify-between px-4 z-50 text-white shadow-sm select-none">
      <div className="flex items-center space-x-4 text-sm font-medium">
        ...
        >
            {/* Apple Logo - Resized to standard 16px (w-4) */}
      ...
      <div className="flex items-center space-x-4 text-sm z-50">
        <div className="flex items-center space-x-5 opacity-90">
            ...
            {/* Search - Standardized */}
            <svg width="22" height="22" viewBox="0 0 24 24" className="w-[18px] h-[18px] fill-white hidden sm:block" xmlns="http://www.w3.org/2000/svg">
                <path d="m9.5 4c3.0376 0 5.5 2.4624 5.5 5.5 0 1.3388-0.4783 2.5659-1.2734 3.5196l4.127 4.1268c0.1952 0.1953 0.1952 0.5119 0 0.7072-0.1736 0.1735-0.443 0.1928-0.6379 0.0578l-0.0693-0.0578-4.1268-4.127c-0.9537 0.7951-2.1808 1.2734-3.5196 1.2734-3.0376 0-5.5-2.4624-5.5-5.5s2.4624-5.5 5.5-5.5zm0 1c-2.4853 0-4.5 2.0147-4.5 4.5s2.0147 4.5 4.5 4.5 4.5-2.0147 4.5-4.5-2.0147-4.5-4.5-4.5z" />
            </svg>

            {/* Control Center - User Provided - Slightly Smaller */}
            <button 
